...
def main(args):
    ...
    test_data = JamendoLyricsDataset(args.sr, args.sepa_dir, args.annot_dir, args.ext)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--annot_dir', type=str, required=True,
                        help='Where the annotation files are stored.')
    parser.add_argument('--ext', type=str, default=".wav",
                        help='The file extension in the sepa_dir; need to be supported by torchaudio.load.')
